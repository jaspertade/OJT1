          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub" display="block">
                          <li><a  href="congress-schedules.php">Add Event</a></li>
                          <li><a  href="gallery.html">Assign Speaker</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2018
              <a href="congress-schedules.php" class="go-top">
